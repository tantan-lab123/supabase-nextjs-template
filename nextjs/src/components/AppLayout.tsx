...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100" dir="rtl">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 right-0 w-64 bg-white shadow-lg transform transition-transform duration-200 ease-in-out z-30 
                ${
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between h-16 bg-white shadow-sm px-4">
          ...
          <div className="relative mr-auto">
            ...
            >
              ...
              <span>{user?.email || "טוען..."}</span>
              <ChevronDown className="h-4 w-4 mr-1" />
            </button>

            {isUserDropdownOpen && (
              <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg border">
                <div className="p-2 border-b border-gray-100">
                  <p className="text-xs text-gray-500">מחובר בתור</p>
                ...
                <div className="py-1">
                  ...
                  >
                    <LogOut className="ml-3 h-4 w-4 text-red-400" />
                    התנתק
                  </button>
                </div>
              </div>
